...
export const Footer = () => {
  return (
    //fixed bottom-0 z-20
    <footer className="mt-auto flex flex-col-reverse items-center gap-2 sm:gap-2 w-full pb-1.5 pt-3 sm:pb-2 max-w-2xl bg-gradient-to-b from-transparent to-green-300/80 backdrop-blur-sm">
      {/* Copyright Text */}
